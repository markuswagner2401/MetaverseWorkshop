...
public class Brush : MonoBehaviour {
    ...
    private void Update() {
        ...
        bool handIsTracking = UpdatePositionSimple();
        ...
        bool triggerPressed = inputActionRef.action.ReadValue<float>() > 0.1f;
    ...
    private bool UpdatePositionSimple()
    {
        _handPosition = handTransform.position;
        _handRotation = handTransform.rotation;
        return true;
    }
}
